...
Donate link: http://robfelty.com/donate
...
```
<?php
					echo '<ul class="collapsCatList" id="widget-collapscat-0-top">' . "\n";
					if (function_exists('collapsCat')) {
					  collapsCat(array(
							'postSort' => 'postDate',
							'postSortOrder' => 'DESC',
...
= 3.0.10 (2025.04.30) =
* Fixed issue with activating the plugin

= 3.0.9 (2024.12.16) =
* Cleaned up some obsolete code
* Removed REST API
* Fixed security issue which could allow users using the REST API to inject
  SQL
